...
class OrderViewSet(viewsets.ModelViewSet):
    queryset = Order.objects.select_related('product').prefetch_related('product__category')
    ...
    def get_queryset(self):
        ...
        if not orders:
            orders = Order.objects.select_related('product').prefetch_related('product__category')
